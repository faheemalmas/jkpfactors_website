...
<head>
    <title>State Machine Execution</title>
</head>

<body>
    <h1>State Machine Execution</h1>
    @if (session('error'))
    ...
    @endif
    <form action="/state/execute" method="POST">
        @csrf
        ...
        <input type="text" id="user_ml_output_csv_s3_uri" name="user_ml_output_csv_s3_uri"
            value="{{ old('user_ml_output_csv_s3_uri') }}">
        ...
        <input type="text" id="user_ml_script_s3_uri" name="user_ml_script_s3_uri"
            value="{{ old('user_ml_script_s3_uri') }}">
