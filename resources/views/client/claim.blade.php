...
@section('content')
    ...
    <section>
        <div class="main">
            <div class="container">
                ...
                <p class="container raleway-font text-dark main-container-text">
                    Below is a list of top performing capped value weighted factors in US over the last year. For more
                ...
                <div class="container">
                    ...
                    <div class="col-md-12 px-5 py-4 my-2" id="parent-container-1">
                        <table class="w-100">
                            <thead>
                                <tr>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <div class="col-12">
                                    <p class="text-center author-dec mb-2">Copenhagen Business School</p>
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <section>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-fullscreen" style="width: 90vw;margin: auto;">
    ...
    <script>
        ...
        function showTable(response) {
            ...
            response.slice(1).forEach((element, key) => {
                let row = `
            <tr>
                ${element.map((item, index) => `<td style="text-transform: uppercase;" data-label="${header[index]}">${item}</td>`).join('')}
            </tr>`;
                tbody.innerHTML += row;
            });
        }
