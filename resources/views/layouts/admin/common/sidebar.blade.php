        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a class="d-flex align-items-center" href="/home"><i data-feather="home"></i><span
                ...
                <ul class="menu-content">
                    <li class="{{ request()->is('home') ? 'active' : '' }}"><a class="d-flex align-items-center"
                            href="/home"><i data-feather="circle"></i><span class="menu-item text-truncate"
                                data-i18n="eCommerce">Main</span></a>
                    </li>

                    <li class="{{ request()->is('reports') || request()->is('factors') ? 'active' : '' }}"><a
                            class="d-flex align-items-center" href="/factors"><i data-feather="circle"></i><span
                                class="menu-item text-truncate" data-i18n="eCommerce">Factors</span></a>
                    </li>

                    <li class="{{ request()->is('ctfdata') || request()->is('ctfdata') ? 'active' : '' }}"><a
                            class="d-flex align-items-center" href="/ctfdata"><i data-feather="circle"></i><span
                                class="menu-item text-truncate" data-i18n="eCommerce">CTF Data</span></a>
                    </li>

                    <li class="{{ request()->is('admin/update*') ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="{{ route('admin.edit') }}">
                            <i data-feather="circle"></i>
                            <span class="menu-item text-truncate" data-i18n="Admin">Admin Settings</span>
                        </a>
                    </li>
